...
const TRAINER_DATA: Record<string, { name: string; role: string; speciality: string; email: string; phone: string; bio: string; photo: string; accent: string }> = {
  "Erik Hansen":  { name: "Erik Hansen",  role: "Sjefstrener", speciality: "HIIT & Boksing",      email: "erik@bergenfitness.no",  phone: "+47 901 23 456", bio: "10 års erfaring. Tidligere norsk boksemester. Spesialiserer seg på intensiv funksjonell trening.", photo: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=120&h=120&fit=crop&crop=face", accent: "#EF4444" },
  "Lise Dahl":    { name: "Lise Dahl",    role: "Yoga & Pilates",  speciality: "Yoga & Pilates",  email: "lise@bergenfitness.no",  phone: "+47 902 34 567", bio: "Sertifisert i Hatha og Vinyasa yoga. Ekspert på bevisst bevegelse og kjernerehabiltering.",      photo: "https://images.unsplash.com/photo-1548690312-e3b507d8c110?w=120&h=120&fit=crop&crop=face", accent: "#8B5CF6" },
