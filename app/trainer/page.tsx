...
const TRAINER_DATA: Record<string, { name: string; role: string; speciality: string; email: string; phone: string; bio: string; photo: string; accent: string }> = {
  "Erik Hansen":  { name: "Erik Hansen",  role: "Sjefstrener", speciality: "HIIT & Boksing",      email: "erik@bergenfitness.no",  phone: "+47 901 23 456", bio: "10 års erfaring. Tidligere norsk boksemester. Spesialiserer seg på intensiv funksjonell trening.", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=120&h=120&fit=crop&crop=face", accent: "#EF4444" },
  "Lise Dahl":    { name: "Lise Dahl",    role: "Yoga & Pilates",  speciality: "Yoga & Pilates",  email: "lise@bergenfitness.no",  phone: "+47 902 34 567", bio: "Sertifisert i Hatha og Vinyasa yoga. Ekspert på bevisst bevegelse og kjernerehabiltering.",      photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=120&h=120&fit=crop&crop=face", accent: "#8B5CF6" },
  "Mads Berg":    { name: "Mads Berg",    role: "Styrke & CrossFit", speciality: "Styrke & CrossFit", email: "mads@bergenfitness.no", phone: "+47 903 45 678", bio: "CrossFit Level 3-trener med styrkløftbakgrunn. Hjelper utøvere med å bygge raskstyrke og utholdenhet.", photo: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=120&h=120&fit=crop", accent: "#F97316" },
  "Sara Moe":     { name: "Sara Moe",     role: "Spinning & Kondisjon", speciality: "Spinning & Kondisjon", email: "sara@bergenfitness.no",  phone: "+47 904 56 789", bio: "Sertifisert for innendørs sykling, 7 års erfaring med konkurransesyklister og mosjonister.",   photo: "https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=120&h=120&fit=crop&crop=face", accent: "#06B6D4" },
};
